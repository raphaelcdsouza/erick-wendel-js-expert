...
console.assert(123 + '' === '123', "inplicit convertion to string")

console.assert(('hello' || 123) === 'hello', "|| returns the first element if both elements are true")
console.assert(('hello' && 123) === 123, "&& returns the last element if both elements are true")
